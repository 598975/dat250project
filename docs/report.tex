...
\author{Adrian Hatlenes Blikås, Andreas Øihaugen, Stian Sletvold Eilertsen og Thorbjørn Petter Melheim}
...
\begin{abstract}
  ...
  The back end is implemented using .NET Core, while the front end uses a single-page application framework Svelt.
