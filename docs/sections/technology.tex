...
The problem habitat brings as shown in figure \ref{fig:problemhabitatmodel} to light the challenges of developing database-driven applications without ORMS frameworks.  \newline
...
The experiment shows that ORMs (EF Core and JPA) significantly reduce development time and boilerplate code compared to raw SQL. EF Core emerged as the most efficient ORM due to its tooling and abstraction. Raw SQL offers maximum control and may be preferable in some spesific cases.
